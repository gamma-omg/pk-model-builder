...
RUN rm -rf /workspace/stable-diffusion-webui/models
RUN git clone https://huggingface.co/webui/ControlNet-modules-safetensors/tree/main /workspace/stable-diffusion-webui/models
